...
Why <b>./</b> in front? Because the shell looks for commands in the directories listed in $PATH, and the directory you are standing in is deliberately not one of them. Writing ./count_reads.sh says "the file right here", rather than asking the shell to go looking.
