...
This version of the course is written for an introductory Master's level bioinformatics course. It assumes you have not used a command line before, and that you will be working on a shared server that someone else administers rather than on a Linux machine of your own. If that describes you, you are in the right place.
